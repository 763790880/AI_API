				...
				deps.groupRepo.SetActive([]service.Group{
					{
						...
						APIKeyBadgeType:     service.GroupAPIKeyBadgeTypeRecommended,
						Status:              service.StatusActive,
		...
		},
		{
			...
			setup: func(t *testing.T, deps *contractDeps) {
				...
				deps.settingRepo.SetAll(map[string]string{
					...
					service.SettingKeySMTPFromName: "CCAPI",
					...
					service.SettingKeySiteName:     "CCAPI",
			...
			wantJSON: `{
				...
				"data": {
					...
					"payment_recharge_center_tab_enabled": false,
					"payment_recharge_tab_enabled": false,
...
func (s *stubAccountRepo) ListWithFilters(ctx context.Context, params pagination.PaginationParams, platform, accountType, status, search, ownerSearch string, groupID, proxyID int64, privacyMode string) ([]service.Account, *pagination.PaginationResult, error) {
	return nil, nil, errors.New("not implemented")
}
...
func (r *stubUsageLogRepo) GetAccountShareRecommendationUsageProfile(ctx context.Context, userID int64, platform, model string, startTime, endTime time.Time) (*service.AccountShareRecommendationUsageProfileStats, error) {
