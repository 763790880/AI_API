...
const (
	GroupAPIKeyBadgeTypeHidden      = "hidden"
	GroupAPIKeyBadgeTypeRecommended = "recommended"
	GroupAPIKeyBadgeTypeConstrained = "constrained"
	GroupAPIKeyBadgeTypeUnavailable = "unavailable"
	GroupAPIKeyBadgeTypeCustom      = "custom"
)
