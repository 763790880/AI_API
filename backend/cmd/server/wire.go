...
// NOTE: 需在有 Go 环境执行 go generate ./... 重新生成 wire_gen.go。
// T03 新增了 SharePolicy/OwnerLedger/Settlement 三件套，wire_gen.go 需重新生成后才会装配。
...
import (
	...
	"github.com/your-org/ai-gateway-platform/ent"
	"github.com/your-org/ai-gateway-platform/internal/config"
	"github.com/your-org/ai-gateway-platform/internal/handler"
	"github.com/your-org/ai-gateway-platform/internal/payment"
	"github.com/your-org/ai-gateway-platform/internal/repository"
	"github.com/your-org/ai-gateway-platform/internal/securityaudit"
	"github.com/your-org/ai-gateway-platform/internal/server"
	"github.com/your-org/ai-gateway-platform/internal/server/middleware"
