...
func (tx *Tx) init() {
	...
	tx.AccountShareMembership = NewAccountShareMembershipClient(tx.config)
	tx.AccountShareRoom = NewAccountShareRoomClient(tx.config)
	...
	tx.OwnerLedger = NewOwnerLedgerClient(tx.config)
	...
	tx.SharePolicy = NewSharePolicyClient(tx.config)
