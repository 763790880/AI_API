...
var (
	...
	AccountsColumns = []*schema.Column{
		...
		{Name: "share_status", Type: field.TypeString, Size: 20, Default: "pending"},
		{Name: "share_policy_id", Type: field.TypeInt64, Nullable: true},
		{Name: "account_level", Type: field.TypeString, Nullable: true, Size: 64},
		{Name: "max_seats", Type: field.TypeInt, Default: 1},
	...
	// AccountShareMembershipsColumns holds the columns for the "account_share_memberships" table.
	AccountShareMembershipsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt64, Increment: true},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		...
		{Name: "queue_expires_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
	}
	// AccountShareMembershipsTable holds the schema information for the "account_share_memberships" table.
	AccountShareMembershipsTable = &schema.Table{
		Name:       "account_share_memberships",
		Columns:    AccountShareMembershipsColumns,
		PrimaryKey: []*schema.Column{AccountShareMembershipsColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "accountsharemembership_room_id",
				Unique:  false,
				Columns: []*schema.Column{AccountShareMembershipsColumns[3]},
			},
			{
				Name:    "accountsharemembership_account_id",
				Unique:  false,
				Columns: []*schema.Column{AccountShareMembershipsColumns[4]},
			},
			{
				Name:    "accountsharemembership_consumer_user_id",
				Unique:  false,
				Columns: []*schema.Column{AccountShareMembershipsColumns[5]},
			},
			{
				Name:    "accountsharemembership_api_key_id",
				Unique:  false,
				Columns: []*schema.Column{AccountShareMembershipsColumns[6]},
			},
			{
				Name:    "accountsharemembership_status",
				Unique:  false,
				Columns: []*schema.Column{AccountShareMembershipsColumns[7]},
			},
			{
				Name:    "accountsharemembership_queue_expires_at",
				Unique:  false,
				Columns: []*schema.Column{AccountShareMembershipsColumns[10]},
			},
		},
	}
	// AccountShareRoomsColumns holds the columns for the "account_share_rooms" table.
	AccountShareRoomsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt64, Increment: true},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		...
		{Name: "name", Type: field.TypeString, Size: 100},
		{Name: "status", Type: field.TypeString, Size: 20, Default: "active"},
		{Name: "seat_limit", Type: field.TypeInt, Default: 5},
		{Name: "rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "allowed_models", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "per_user_concurrency", Type: field.TypeInt, Default: 1},
		{Name: "queue_max", Type: field.TypeInt, Default: 20},
		{Name: "version", Type: field.TypeInt, Default: 0},
	}
	// AccountShareRoomsTable holds the schema information for the "account_share_rooms" table.
	AccountShareRoomsTable = &schema.Table{
		Name:       "account_share_rooms",
		Columns:    AccountShareRoomsColumns,
		PrimaryKey: []*schema.Column{AccountShareRoomsColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "accountshareroom_owner_user_id",
				Unique:  false,
				Columns: []*schema.Column{AccountShareRoomsColumns[4]},
			},
			{
				Name:    "accountshareroom_status",
				Unique:  false,
				Columns: []*schema.Column{AccountShareRoomsColumns[6]},
			},
		},
	}
	...
	// OwnerLedgersColumns holds the columns for the "owner_ledgers" table.
	OwnerLedgersColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt64, Increment: true},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "owner_user_id", Type: field.TypeInt64},
		...
		{Name: "balance_before", Type: field.TypeFloat64, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		...
		{Name: "ref_type", Type: field.TypeString, Nullable: true, Size: 30},
		{Name: "ref_id", Type: field.TypeInt64, Nullable: true},
		{Name: "metadata", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
	}
	// OwnerLedgersTable holds the schema information for the "owner_ledgers" table.
	OwnerLedgersTable = &schema.Table{
		Name:       "owner_ledgers",
		Columns:    OwnerLedgersColumns,
		PrimaryKey: []*schema.Column{OwnerLedgersColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "ownerledger_owner_user_id",
				Unique:  false,
				Columns: []*schema.Column{OwnerLedgersColumns[3]},
			},
			{
				Name:    "ownerledger_owner_user_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{OwnerLedgersColumns[3], OwnerLedgersColumns[1]},
			},
			{
				Name:    "ownerledger_direction",
				Unique:  false,
				Columns: []*schema.Column{OwnerLedgersColumns[4]},
			},
			{
				Name:    "ownerledger_entry_type",
				Unique:  false,
				Columns: []*schema.Column{OwnerLedgersColumns[8]},
			},
			{
				Name:    "ownerledger_ref_type_ref_id",
				Unique:  false,
				Columns: []*schema.Column{OwnerLedgersColumns[9], OwnerLedgersColumns[10]},
			},
		},
	}
	...
	SettlementsColumns = []*schema.Column{
		...
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "owner_user_id", Type: field.TypeInt64},
		{Name: "settlement_no", Type: field.TypeString, Unique: true, Size: 64},
		...
		{Name: "gross_amount", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "fee_amount", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "net_amount", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
	...
	SettlementsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			{
				Name:    "settlement_owner_user_id",
				Unique:  false,
				Columns: []*schema.Column{SettlementsColumns[3]},
			},
			{
				Name:    "settlement_owner_user_id_status",
				Unique:  false,
				Columns: []*schema.Column{SettlementsColumns[3], SettlementsColumns[10]},
			},
			{
			...
			{
				Name:    "settlement_period_start_period_end",
				Unique:  false,
				Columns: []*schema.Column{SettlementsColumns[5], SettlementsColumns[6]},
			},
		},
	}
	// SharePoliciesColumns holds the columns for the "share_policies" table.
	SharePoliciesColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt64, Increment: true},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "deleted_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "scope_type", Type: field.TypeString, Size: 20},
		{Name: "scope_id", Type: field.TypeInt64, Nullable: true},
		{Name: "platform", Type: field.TypeString, Nullable: true, Size: 50},
		{Name: "owner_share_ratio", Type: field.TypeFloat64, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "invite_share_ratio", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
	...
	// SharePoliciesTable holds the schema information for the "share_policies" table.
	SharePoliciesTable = &schema.Table{
		Name:       "share_policies",
		Columns:    SharePoliciesColumns,
		PrimaryKey: []*schema.Column{SharePoliciesColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "sharepolicy_scope_type_scope_id",
				Unique:  false,
				Columns: []*schema.Column{SharePoliciesColumns[4], SharePoliciesColumns[5]},
			},
			{
				Name:    "sharepolicy_platform",
				Unique:  false,
				Columns: []*schema.Column{SharePoliciesColumns[6]},
			},
			{
				Name:    "sharepolicy_enabled",
				Unique:  false,
				Columns: []*schema.Column{SharePoliciesColumns[10]},
			},
			{
				Name:    "sharepolicy_deleted_at",
				Unique:  false,
				Columns: []*schema.Column{SharePoliciesColumns[3]},
			},
		},
	}
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "rpm_limit", Type: field.TypeInt, Default: 0},
		{Name: "can_host_accounts", Type: field.TypeBool, Default: false},
	}
	...
	WithdrawalsColumns = []*schema.Column{
		...
		{Name: "amount", Type: field.TypeFloat64, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "fee_amount", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "total_deducted", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "balance_before", Type: field.TypeFloat64, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "balance_after", Type: field.TypeFloat64, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "payment_method", Type: field.TypeString, Size: 20},
		{Name: "payment_account", Type: field.TypeString, Size: 255},
		{Name: "status", Type: field.TypeString, Size: 20, Default: "pending"},
		{Name: "processed_by_user_id", Type: field.TypeInt64, Nullable: true},
	...
	WithdrawalsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			{
				Name:    "withdrawal_owner_user_id",
				Unique:  false,
				Columns: []*schema.Column{WithdrawalsColumns[3]},
			},
			{
				Name:    "withdrawal_owner_user_id_status",
				Unique:  false,
				Columns: []*schema.Column{WithdrawalsColumns[3], WithdrawalsColumns[11]},
			},
			{
				Name:    "withdrawal_status",
				Unique:  false,
				Columns: []*schema.Column{WithdrawalsColumns[11]},
			},
			{
				Name:    "withdrawal_processed_by_user_id",
				Unique:  false,
				Columns: []*schema.Column{WithdrawalsColumns[12]},
			},
		},
	}
	...
	Tables = []*schema.Table{
		...
		AccountsTable,
		AccountGroupsTable,
		AccountShareMembershipsTable,
		AccountShareRoomsTable,
		AnnouncementsTable,
...
func init() {
	...
	AccountShareMembershipsTable.Annotation = &entsql.Annotation{
		Table: "account_share_memberships",
	}
	AccountShareRoomsTable.Annotation = &entsql.Annotation{
	...
	OwnerLedgersTable.Annotation = &entsql.Annotation{
		Table: "owner_ledgers",
	}
	...
	SharePoliciesTable.Annotation = &entsql.Annotation{
	...
	WithdrawalsTable.Annotation = &entsql.Annotation{
		Table: "withdrawals",
	}
}
