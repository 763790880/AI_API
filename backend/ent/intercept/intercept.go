...
// The AccountShareMembershipFunc type is an adapter to allow the use of ordinary function as a Querier.
type AccountShareMembershipFunc func(context.Context, *ent.AccountShareMembershipQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f AccountShareMembershipFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.AccountShareMembershipQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.AccountShareMembershipQuery", q)
}

// The TraverseAccountShareMembership type is an adapter to allow the use of ordinary function as Traverser.
type TraverseAccountShareMembership func(context.Context, *ent.AccountShareMembershipQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseAccountShareMembership) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseAccountShareMembership) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.AccountShareMembershipQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.AccountShareMembershipQuery", q)
}

// The AccountShareRoomFunc type is an adapter to allow the use of ordinary function as a Querier.
type AccountShareRoomFunc func(context.Context, *ent.AccountShareRoomQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f AccountShareRoomFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.AccountShareRoomQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.AccountShareRoomQuery", q)
}

// The TraverseAccountShareRoom type is an adapter to allow the use of ordinary function as Traverser.
type TraverseAccountShareRoom func(context.Context, *ent.AccountShareRoomQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseAccountShareRoom) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseAccountShareRoom) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.AccountShareRoomQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.AccountShareRoomQuery", q)
}
...
// The OwnerLedgerFunc type is an adapter to allow the use of ordinary function as a Querier.
type OwnerLedgerFunc func(context.Context, *ent.OwnerLedgerQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f OwnerLedgerFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.OwnerLedgerQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.OwnerLedgerQuery", q)
}

// The TraverseOwnerLedger type is an adapter to allow the use of ordinary function as Traverser.
type TraverseOwnerLedger func(context.Context, *ent.OwnerLedgerQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseOwnerLedger) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseOwnerLedger) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.OwnerLedgerQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.OwnerLedgerQuery", q)
}
...
// The SharePolicyFunc type is an adapter to allow the use of ordinary function as a Querier.
type SharePolicyFunc func(context.Context, *ent.SharePolicyQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f SharePolicyFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.SharePolicyQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.SharePolicyQuery", q)
}

// The TraverseSharePolicy type is an adapter to allow the use of ordinary function as Traverser.
type TraverseSharePolicy func(context.Context, *ent.SharePolicyQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseSharePolicy) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseSharePolicy) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.SharePolicyQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.SharePolicyQuery", q)
}
...
// The WithdrawalFunc type is an adapter to allow the use of ordinary function as a Querier.
type WithdrawalFunc func(context.Context, *ent.WithdrawalQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f WithdrawalFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.WithdrawalQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.WithdrawalQuery", q)
}

// The TraverseWithdrawal type is an adapter to allow the use of ordinary function as Traverser.
type TraverseWithdrawal func(context.Context, *ent.WithdrawalQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseWithdrawal) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseWithdrawal) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.WithdrawalQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.WithdrawalQuery", q)
}
...
func NewQuery(q ent.Query) (Query, error) {
	...
	case *ent.AccountShareMembershipQuery:
		return &query[*ent.AccountShareMembershipQuery, predicate.AccountShareMembership, accountsharemembership.OrderOption]{typ: ent.TypeAccountShareMembership, tq: q}, nil
	case *ent.AccountShareRoomQuery:
		return &query[*ent.AccountShareRoomQuery, predicate.AccountShareRoom, accountshareroom.OrderOption]{typ: ent.TypeAccountShareRoom, tq: q}, nil
	...
	case *ent.OwnerLedgerQuery:
		return &query[*ent.OwnerLedgerQuery, predicate.OwnerLedger, ownerledger.OrderOption]{typ: ent.TypeOwnerLedger, tq: q}, nil
	...
	case *ent.SharePolicyQuery:
		return &query[*ent.SharePolicyQuery, predicate.SharePolicy, sharepolicy.OrderOption]{typ: ent.TypeSharePolicy, tq: q}, nil
	...
	case *ent.WithdrawalQuery:
		return &query[*ent.WithdrawalQuery, predicate.Withdrawal, withdrawal.OrderOption]{typ: ent.TypeWithdrawal, tq: q}, nil
	default:
