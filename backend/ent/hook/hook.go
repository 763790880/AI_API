...
// The AccountShareMembershipFunc type is an adapter to allow the use of ordinary
// function as AccountShareMembership mutator.
type AccountShareMembershipFunc func(context.Context, *ent.AccountShareMembershipMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AccountShareMembershipFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.AccountShareMembershipMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AccountShareMembershipMutation", m)
}

// The AccountShareRoomFunc type is an adapter to allow the use of ordinary
// function as AccountShareRoom mutator.
type AccountShareRoomFunc func(context.Context, *ent.AccountShareRoomMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AccountShareRoomFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.AccountShareRoomMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AccountShareRoomMutation", m)
}
...
// The OwnerLedgerFunc type is an adapter to allow the use of ordinary
// function as OwnerLedger mutator.
type OwnerLedgerFunc func(context.Context, *ent.OwnerLedgerMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f OwnerLedgerFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.OwnerLedgerMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.OwnerLedgerMutation", m)
}
...
// Mutate calls f(ctx, m).
func (f SharePolicyFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.SharePolicyMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.SharePolicyMutation", m)
}
