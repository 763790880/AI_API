...
import (
	...
	"github.com/your-org/ai-gateway-platform/ent/migrate"
...
type Client struct {
	...
	// AccountShareMembership is the client for interacting with the AccountShareMembership builders.
	AccountShareMembership *AccountShareMembershipClient
	// AccountShareRoom is the client for interacting with the AccountShareRoom builders.
	AccountShareRoom *AccountShareRoomClient
	...
	// OwnerLedger is the client for interacting with the OwnerLedger builders.
	OwnerLedger *OwnerLedgerClient
...
func (c *Client) init() {
	...
	c.AccountShareMembership = NewAccountShareMembershipClient(c.config)
	c.AccountShareRoom = NewAccountShareRoomClient(c.config)
	...
	c.OwnerLedger = NewOwnerLedgerClient(c.config)
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	return &Tx{
		...
		AccountShareMembership:        NewAccountShareMembershipClient(cfg),
		AccountShareRoom:              NewAccountShareRoomClient(cfg),
		...
		OwnerLedger:                   NewOwnerLedgerClient(cfg),
...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		c.APIKey, c.Account, c.AccountGroup, c.AccountShareMembership,
		c.AccountShareRoom, c.Announcement, c.AnnouncementRead, c.AuthIdentity,
		...
		c.Group, c.IdempotencyRecord, c.IdentityAdoptionDecision, c.OwnerLedger,
		c.PaymentAuditLog, c.PaymentOrder, c.PaymentProviderInstance,
		c.PendingAuthSession, c.PromoCode, c.PromoCodeUsage, c.Proxy, c.RedeemCode,
		c.SecuritySecret, c.Setting, c.Settlement, c.SharePolicy, c.SubscriptionPlan,
		c.TLSFingerprintProfile, c.UsageCleanupTask, c.UsageLog, c.User,
		c.UserAllowedGroup, c.UserAttributeDefinition, c.UserAttributeValue,
		c.UserPlatformQuota, c.UserSubscription, c.Withdrawal,
	} {
		n.Use(hooks...)
	}
}
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	case *AccountShareMembershipMutation:
		return c.AccountShareMembership.mutate(ctx, m)
	case *AccountShareRoomMutation:
		return c.AccountShareRoom.mutate(ctx, m)
	...
	case *OwnerLedgerMutation:
		return c.OwnerLedger.mutate(ctx, m)
...
// AccountShareMembershipClient is a client for the AccountShareMembership schema.
type AccountShareMembershipClient struct {
	config
}

// NewAccountShareMembershipClient returns a client for the AccountShareMembership from the given config.
func NewAccountShareMembershipClient(c config) *AccountShareMembershipClient {
	return &AccountShareMembershipClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `accountsharemembership.Hooks(f(g(h())))`.
func (c *AccountShareMembershipClient) Use(hooks ...Hook) {
	c.hooks.AccountShareMembership = append(c.hooks.AccountShareMembership, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `accountsharemembership.Intercept(f(g(h())))`.
func (c *AccountShareMembershipClient) Intercept(interceptors ...Interceptor) {
	c.inters.AccountShareMembership = append(c.inters.AccountShareMembership, interceptors...)
}

// Create returns a builder for creating a AccountShareMembership entity.
func (c *AccountShareMembershipClient) Create() *AccountShareMembershipCreate {
	mutation := newAccountShareMembershipMutation(c.config, OpCreate)
	return &AccountShareMembershipCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of AccountShareMembership entities.
func (c *AccountShareMembershipClient) CreateBulk(builders ...*AccountShareMembershipCreate) *AccountShareMembershipCreateBulk {
	return &AccountShareMembershipCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *AccountShareMembershipClient) MapCreateBulk(slice any, setFunc func(*AccountShareMembershipCreate, int)) *AccountShareMembershipCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &AccountShareMembershipCreateBulk{err: fmt.Errorf("calling to AccountShareMembershipClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*AccountShareMembershipCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for AccountShareMembership.
func (c *AccountShareMembershipClient) Update() *AccountShareMembershipUpdate {
	mutation := newAccountShareMembershipMutation(c.config, OpUpdate)
	return &AccountShareMembershipUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *AccountShareMembershipClient) UpdateOne(_m *AccountShareMembership) *AccountShareMembershipUpdateOne {
	mutation := newAccountShareMembershipMutation(c.config, OpUpdateOne, withAccountShareMembership(_m))
	return &AccountShareMembershipUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *AccountShareMembershipClient) UpdateOneID(id int64) *AccountShareMembershipUpdateOne {
	mutation := newAccountShareMembershipMutation(c.config, OpUpdateOne, withAccountShareMembershipID(id))
	return &AccountShareMembershipUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for AccountShareMembership.
func (c *AccountShareMembershipClient) Delete() *AccountShareMembershipDelete {
	mutation := newAccountShareMembershipMutation(c.config, OpDelete)
	return &AccountShareMembershipDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *AccountShareMembershipClient) DeleteOne(_m *AccountShareMembership) *AccountShareMembershipDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *AccountShareMembershipClient) DeleteOneID(id int64) *AccountShareMembershipDeleteOne {
	builder := c.Delete().Where(accountsharemembership.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &AccountShareMembershipDeleteOne{builder}
}

// Query returns a query builder for AccountShareMembership.
func (c *AccountShareMembershipClient) Query() *AccountShareMembershipQuery {
	return &AccountShareMembershipQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeAccountShareMembership},
		inters: c.Interceptors(),
	}
}

// Get returns a AccountShareMembership entity by its id.
func (c *AccountShareMembershipClient) Get(ctx context.Context, id int64) (*AccountShareMembership, error) {
	return c.Query().Where(accountsharemembership.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *AccountShareMembershipClient) GetX(ctx context.Context, id int64) *AccountShareMembership {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *AccountShareMembershipClient) Hooks() []Hook {
	return c.hooks.AccountShareMembership
}

// Interceptors returns the client interceptors.
func (c *AccountShareMembershipClient) Interceptors() []Interceptor {
	return c.inters.AccountShareMembership
}

func (c *AccountShareMembershipClient) mutate(ctx context.Context, m *AccountShareMembershipMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&AccountShareMembershipCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&AccountShareMembershipUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&AccountShareMembershipUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&AccountShareMembershipDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("ent: unknown AccountShareMembership mutation op: %q", m.Op())
	}
}

// AccountShareRoomClient is a client for the AccountShareRoom schema.
type AccountShareRoomClient struct {
	config
}

// NewAccountShareRoomClient returns a client for the AccountShareRoom from the given config.
func NewAccountShareRoomClient(c config) *AccountShareRoomClient {
	return &AccountShareRoomClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `accountshareroom.Hooks(f(g(h())))`.
func (c *AccountShareRoomClient) Use(hooks ...Hook) {
	c.hooks.AccountShareRoom = append(c.hooks.AccountShareRoom, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `accountshareroom.Intercept(f(g(h())))`.
func (c *AccountShareRoomClient) Intercept(interceptors ...Interceptor) {
	c.inters.AccountShareRoom = append(c.inters.AccountShareRoom, interceptors...)
}

// Create returns a builder for creating a AccountShareRoom entity.
func (c *AccountShareRoomClient) Create() *AccountShareRoomCreate {
	mutation := newAccountShareRoomMutation(c.config, OpCreate)
	return &AccountShareRoomCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of AccountShareRoom entities.
func (c *AccountShareRoomClient) CreateBulk(builders ...*AccountShareRoomCreate) *AccountShareRoomCreateBulk {
	return &AccountShareRoomCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *AccountShareRoomClient) MapCreateBulk(slice any, setFunc func(*AccountShareRoomCreate, int)) *AccountShareRoomCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &AccountShareRoomCreateBulk{err: fmt.Errorf("calling to AccountShareRoomClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*AccountShareRoomCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for AccountShareRoom.
func (c *AccountShareRoomClient) Update() *AccountShareRoomUpdate {
	mutation := newAccountShareRoomMutation(c.config, OpUpdate)
	return &AccountShareRoomUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *AccountShareRoomClient) UpdateOne(_m *AccountShareRoom) *AccountShareRoomUpdateOne {
	mutation := newAccountShareRoomMutation(c.config, OpUpdateOne, withAccountShareRoom(_m))
	return &AccountShareRoomUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *AccountShareRoomClient) UpdateOneID(id int64) *AccountShareRoomUpdateOne {
	mutation := newAccountShareRoomMutation(c.config, OpUpdateOne, withAccountShareRoomID(id))
	return &AccountShareRoomUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for AccountShareRoom.
func (c *AccountShareRoomClient) Delete() *AccountShareRoomDelete {
	mutation := newAccountShareRoomMutation(c.config, OpDelete)
	return &AccountShareRoomDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *AccountShareRoomClient) DeleteOne(_m *AccountShareRoom) *AccountShareRoomDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *AccountShareRoomClient) DeleteOneID(id int64) *AccountShareRoomDeleteOne {
	builder := c.Delete().Where(accountshareroom.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &AccountShareRoomDeleteOne{builder}
}

// Query returns a query builder for AccountShareRoom.
func (c *AccountShareRoomClient) Query() *AccountShareRoomQuery {
	return &AccountShareRoomQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeAccountShareRoom},
		inters: c.Interceptors(),
	}
}

// Get returns a AccountShareRoom entity by its id.
func (c *AccountShareRoomClient) Get(ctx context.Context, id int64) (*AccountShareRoom, error) {
	return c.Query().Where(accountshareroom.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *AccountShareRoomClient) GetX(ctx context.Context, id int64) *AccountShareRoom {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *AccountShareRoomClient) Hooks() []Hook {
	return c.hooks.AccountShareRoom
}

// Interceptors returns the client interceptors.
func (c *AccountShareRoomClient) Interceptors() []Interceptor {
	return c.inters.AccountShareRoom
}

func (c *AccountShareRoomClient) mutate(ctx context.Context, m *AccountShareRoomMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&AccountShareRoomCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&AccountShareRoomUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&AccountShareRoomUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&AccountShareRoomDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("ent: unknown AccountShareRoom mutation op: %q", m.Op())
	}
}
...
// OwnerLedgerClient is a client for the OwnerLedger schema.
type OwnerLedgerClient struct {
	config
}

// NewOwnerLedgerClient returns a client for the OwnerLedger from the given config.
func NewOwnerLedgerClient(c config) *OwnerLedgerClient {
	return &OwnerLedgerClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `ownerledger.Hooks(f(g(h())))`.
func (c *OwnerLedgerClient) Use(hooks ...Hook) {
	c.hooks.OwnerLedger = append(c.hooks.OwnerLedger, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `ownerledger.Intercept(f(g(h())))`.
func (c *OwnerLedgerClient) Intercept(interceptors ...Interceptor) {
	c.inters.OwnerLedger = append(c.inters.OwnerLedger, interceptors...)
}

// Create returns a builder for creating a OwnerLedger entity.
func (c *OwnerLedgerClient) Create() *OwnerLedgerCreate {
	mutation := newOwnerLedgerMutation(c.config, OpCreate)
	return &OwnerLedgerCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of OwnerLedger entities.
func (c *OwnerLedgerClient) CreateBulk(builders ...*OwnerLedgerCreate) *OwnerLedgerCreateBulk {
	return &OwnerLedgerCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *OwnerLedgerClient) MapCreateBulk(slice any, setFunc func(*OwnerLedgerCreate, int)) *OwnerLedgerCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &OwnerLedgerCreateBulk{err: fmt.Errorf("calling to OwnerLedgerClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*OwnerLedgerCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for OwnerLedger.
func (c *OwnerLedgerClient) Update() *OwnerLedgerUpdate {
	mutation := newOwnerLedgerMutation(c.config, OpUpdate)
	return &OwnerLedgerUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *OwnerLedgerClient) UpdateOne(_m *OwnerLedger) *OwnerLedgerUpdateOne {
	mutation := newOwnerLedgerMutation(c.config, OpUpdateOne, withOwnerLedger(_m))
	return &OwnerLedgerUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *OwnerLedgerClient) UpdateOneID(id int64) *OwnerLedgerUpdateOne {
	mutation := newOwnerLedgerMutation(c.config, OpUpdateOne, withOwnerLedgerID(id))
	return &OwnerLedgerUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for OwnerLedger.
func (c *OwnerLedgerClient) Delete() *OwnerLedgerDelete {
	mutation := newOwnerLedgerMutation(c.config, OpDelete)
	return &OwnerLedgerDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *OwnerLedgerClient) DeleteOne(_m *OwnerLedger) *OwnerLedgerDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *OwnerLedgerClient) DeleteOneID(id int64) *OwnerLedgerDeleteOne {
	builder := c.Delete().Where(ownerledger.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &OwnerLedgerDeleteOne{builder}
}

// Query returns a query builder for OwnerLedger.
func (c *OwnerLedgerClient) Query() *OwnerLedgerQuery {
	return &OwnerLedgerQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeOwnerLedger},
		inters: c.Interceptors(),
	}
}

// Get returns a OwnerLedger entity by its id.
func (c *OwnerLedgerClient) Get(ctx context.Context, id int64) (*OwnerLedger, error) {
	return c.Query().Where(ownerledger.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *OwnerLedgerClient) GetX(ctx context.Context, id int64) *OwnerLedger {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *OwnerLedgerClient) Hooks() []Hook {
	return c.hooks.OwnerLedger
}

// Interceptors returns the client interceptors.
func (c *OwnerLedgerClient) Interceptors() []Interceptor {
	return c.inters.OwnerLedger
}

func (c *OwnerLedgerClient) mutate(ctx context.Context, m *OwnerLedgerMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&OwnerLedgerCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&OwnerLedgerUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&OwnerLedgerUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&OwnerLedgerDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("ent: unknown OwnerLedger mutation op: %q", m.Op())
	}
}
...
// UpdateOneID returns an update builder for the given id.
func (c *SettlementClient) UpdateOneID(id int64) *SettlementUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *SettlementClient) DeleteOneID(id int64) *SettlementDeleteOne {
...
func (c *SettlementClient) Get(ctx context.Context, id int64) (*Settlement, error) {
	return c.Query().Where(settlement.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *SettlementClient) GetX(ctx context.Context, id int64) *Settlement {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// UpdateOneID returns an update builder for the given id.
func (c *SharePolicyClient) UpdateOneID(id int64) *SharePolicyUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *SharePolicyClient) DeleteOneID(id int64) *SharePolicyDeleteOne {
...
func (c *SharePolicyClient) Get(ctx context.Context, id int64) (*SharePolicy, error) {
	return c.Query().Where(sharepolicy.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *SharePolicyClient) GetX(ctx context.Context, id int64) *SharePolicy {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
func (c *SharePolicyClient) Interceptors() []Interceptor {
	inters := c.inters.SharePolicy
	return append(inters[:len(inters):len(inters)], sharepolicy.Interceptors[:]...)
}
...
// UpdateOneID returns an update builder for the given id.
func (c *WithdrawalClient) UpdateOneID(id int64) *WithdrawalUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *WithdrawalClient) DeleteOneID(id int64) *WithdrawalDeleteOne {
...
func (c *WithdrawalClient) Get(ctx context.Context, id int64) (*Withdrawal, error) {
	return c.Query().Where(withdrawal.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *WithdrawalClient) GetX(ctx context.Context, id int64) *Withdrawal {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
type (
	hooks struct {
		APIKey, Account, AccountGroup, AccountShareMembership, AccountShareRoom,
		...
		Group, IdempotencyRecord, IdentityAdoptionDecision, OwnerLedger,
		PaymentAuditLog, PaymentOrder, PaymentProviderInstance, PendingAuthSession,
		PromoCode, PromoCodeUsage, Proxy, RedeemCode, SecuritySecret, Setting,
		Settlement, SharePolicy, SubscriptionPlan, TLSFingerprintProfile,
		UsageCleanupTask, UsageLog, User, UserAllowedGroup, UserAttributeDefinition,
		UserAttributeValue, UserPlatformQuota, UserSubscription, Withdrawal []ent.Hook
	}
	inters struct {
		APIKey, Account, AccountGroup, AccountShareMembership, AccountShareRoom,
		Announcement, AnnouncementRead, AuthIdentity, AuthIdentityChannel,
