...
// CanHostAccounts applies equality check predicate on the "can_host_accounts" field. It's identical to CanHostAccountsEQ.
func CanHostAccounts(v bool) predicate.User {
	return predicate.User(sql.FieldEQ(FieldCanHostAccounts, v))
}
...
// CanHostAccountsEQ applies the EQ predicate on the "can_host_accounts" field.
func CanHostAccountsEQ(v bool) predicate.User {
	return predicate.User(sql.FieldEQ(FieldCanHostAccounts, v))
}

// CanHostAccountsNEQ applies the NEQ predicate on the "can_host_accounts" field.
func CanHostAccountsNEQ(v bool) predicate.User {
	return predicate.User(sql.FieldNEQ(FieldCanHostAccounts, v))
}
