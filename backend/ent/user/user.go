...
const (
	...
	// FieldCanHostAccounts holds the string denoting the can_host_accounts field in the database.
	FieldCanHostAccounts = "can_host_accounts"
...
var (
	...
	DefaultRpmLimit int
	// DefaultCanHostAccounts holds the default value on creation for the "can_host_accounts" field.
	DefaultCanHostAccounts bool
)
...
// ByCanHostAccounts orders the results by the can_host_accounts field.
func ByCanHostAccounts(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldCanHostAccounts, opts...).ToFunc()
}
