...
// SetMaxSeats sets the "max_seats" field.
func (_c *AccountCreate) SetMaxSeats(v int) *AccountCreate {
	_c.mutation.SetMaxSeats(v)
	return _c
}

// SetNillableMaxSeats sets the "max_seats" field if the given value is not nil.
func (_c *AccountCreate) SetNillableMaxSeats(v *int) *AccountCreate {
	if v != nil {
		_c.SetMaxSeats(*v)
	}
	return _c
...
func (_c *AccountCreate) defaults() error {
	...
	if _, ok := _c.mutation.MaxSeats(); !ok {
		v := account.DefaultMaxSeats
		_c.mutation.SetMaxSeats(v)
	}
...
func (_c *AccountCreate) check() error {
	...
	if _, ok := _c.mutation.MaxSeats(); !ok {
		return &ValidationError{Name: "max_seats", err: errors.New(`ent: missing required field "Account.max_seats"`)}
	}
	if _, ok := _c.mutation.Concurrency(); !ok {
...
func (_c *AccountCreate) createSpec() (*Account, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.MaxSeats(); ok {
		_spec.SetField(account.FieldMaxSeats, field.TypeInt, value)
...
// ClearAccountLevel clears the value of the "account_level" field.
func (u *AccountUpsert) ClearAccountLevel() *AccountUpsert {
	u.SetNull(account.FieldAccountLevel)
	return u
}

// SetMaxSeats sets the "max_seats" field.
func (u *AccountUpsert) SetMaxSeats(v int) *AccountUpsert {
	u.Set(account.FieldMaxSeats, v)
	return u
}

// UpdateMaxSeats sets the "max_seats" field to the value that was provided on create.
func (u *AccountUpsert) UpdateMaxSeats() *AccountUpsert {
	u.SetExcluded(account.FieldMaxSeats)
	return u
}

// AddMaxSeats adds v to the "max_seats" field.
func (u *AccountUpsert) AddMaxSeats(v int) *AccountUpsert {
	u.Add(account.FieldMaxSeats, v)
	return u
}
...
// ClearAccountLevel clears the value of the "account_level" field.
func (u *AccountUpsertOne) ClearAccountLevel() *AccountUpsertOne {
	return u.Update(func(s *AccountUpsert) {
		s.ClearAccountLevel()
	})
}
...
// SetMaxSeats sets the "max_seats" field.
func (u *AccountUpsertOne) SetMaxSeats(v int) *AccountUpsertOne {
	return u.Update(func(s *AccountUpsert) {
		s.SetMaxSeats(v)
	})
}
...
// AddMaxSeats adds v to the "max_seats" field.
func (u *AccountUpsertOne) AddMaxSeats(v int) *AccountUpsertOne {
	return u.Update(func(s *AccountUpsert) {
		s.AddMaxSeats(v)
	})
}
...
// UpdateMaxSeats sets the "max_seats" field to the value that was provided on create.
func (u *AccountUpsertOne) UpdateMaxSeats() *AccountUpsertOne {
	return u.Update(func(s *AccountUpsert) {
		s.UpdateMaxSeats()
	})
}
...
// ClearAccountLevel clears the value of the "account_level" field.
func (u *AccountUpsertBulk) ClearAccountLevel() *AccountUpsertBulk {
	return u.Update(func(s *AccountUpsert) {
		s.ClearAccountLevel()
	})
}
...
// SetMaxSeats sets the "max_seats" field.
func (u *AccountUpsertBulk) SetMaxSeats(v int) *AccountUpsertBulk {
	return u.Update(func(s *AccountUpsert) {
		s.SetMaxSeats(v)
	})
}
...
// AddMaxSeats adds v to the "max_seats" field.
func (u *AccountUpsertBulk) AddMaxSeats(v int) *AccountUpsertBulk {
	return u.Update(func(s *AccountUpsert) {
		s.AddMaxSeats(v)
	})
}
...
// UpdateMaxSeats sets the "max_seats" field to the value that was provided on create.
func (u *AccountUpsertBulk) UpdateMaxSeats() *AccountUpsertBulk {
	return u.Update(func(s *AccountUpsert) {
		s.UpdateMaxSeats()
	})
}
