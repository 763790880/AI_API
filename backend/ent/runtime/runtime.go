...
import (
	...
	"github.com/your-org/ai-gateway-platform/ent/account"
	...
	"github.com/your-org/ai-gateway-platform/ent/batchimageevent"
	"github.com/your-org/ai-gateway-platform/ent/batchimageitem"
	"github.com/your-org/ai-gateway-platform/ent/batchimagejob"
	"github.com/your-org/ai-gateway-platform/ent/channelmonitor"
	"github.com/your-org/ai-gateway-platform/ent/channelmonitordailyrollup"
	...
	"github.com/your-org/ai-gateway-platform/ent/idempotencyrecord"
	...
	"github.com/your-org/ai-gateway-platform/ent/schema"
	...
	"github.com/your-org/ai-gateway-platform/ent/usagecleanuptask"
	"github.com/your-org/ai-gateway-platform/ent/usagelog"
...
func init() {
	...
	accountDescAccountLevel := accountFields[10].Descriptor()
	...
	// accountDescMaxSeats is the schema descriptor for max_seats field.
	accountDescMaxSeats := accountFields[11].Descriptor()
	// account.DefaultMaxSeats holds the default value on creation for the max_seats field.
	account.DefaultMaxSeats = accountDescMaxSeats.Default.(int)
	...
	accountDescPriority := accountFields[16].Descriptor()
	// account.DefaultPriority holds the default value on creation for the priority field.
	account.DefaultPriority = accountDescPriority.Default.(int)
	// accountDescRateMultiplier is the schema descriptor for rate_multiplier field.
	accountDescRateMultiplier := accountFields[17].Descriptor()
	// account.DefaultRateMultiplier holds the default value on creation for the rate_multiplier field.
	account.DefaultRateMultiplier = accountDescRateMultiplier.Default.(float64)
	// accountDescStatus is the schema descriptor for status field.
	accountDescStatus := accountFields[18].Descriptor()
	...
	accountsharemembershipMixin := schema.AccountShareMembership{}.Mixin()
	accountsharemembershipMixinFields0 := accountsharemembershipMixin[0].Fields()
	_ = accountsharemembershipMixinFields0
	accountsharemembershipFields := schema.AccountShareMembership{}.Fields()
	_ = accountsharemembershipFields
	// accountsharemembershipDescCreatedAt is the schema descriptor for created_at field.
	accountsharemembershipDescCreatedAt := accountsharemembershipMixinFields0[0].Descriptor()
	// accountsharemembership.DefaultCreatedAt holds the default value on creation for the created_at field.
	accountsharemembership.DefaultCreatedAt = accountsharemembershipDescCreatedAt.Default.(func() time.Time)
	// accountsharemembershipDescUpdatedAt is the schema descriptor for updated_at field.
	accountsharemembershipDescUpdatedAt := accountsharemembershipMixinFields0[1].Descriptor()
	// accountsharemembership.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	accountsharemembership.DefaultUpdatedAt = accountsharemembershipDescUpdatedAt.Default.(func() time.Time)
	// accountsharemembership.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	accountsharemembership.UpdateDefaultUpdatedAt = accountsharemembershipDescUpdatedAt.UpdateDefault.(func() time.Time)
	// accountsharemembershipDescStatus is the schema descriptor for status field.
	accountsharemembershipDescStatus := accountsharemembershipFields[4].Descriptor()
	// accountsharemembership.DefaultStatus holds the default value on creation for the status field.
	accountsharemembership.DefaultStatus = accountsharemembershipDescStatus.Default.(string)
	// accountsharemembership.StatusValidator is a validator for the "status" field. It is called by the builders before save.
	accountsharemembership.StatusValidator = accountsharemembershipDescStatus.Validators[0].(func(string) error)
	// accountsharemembershipDescJoinedAt is the schema descriptor for joined_at field.
	accountsharemembershipDescJoinedAt := accountsharemembershipFields[5].Descriptor()
	// accountsharemembership.DefaultJoinedAt holds the default value on creation for the joined_at field.
	accountsharemembership.DefaultJoinedAt = accountsharemembershipDescJoinedAt.Default.(func() time.Time)
	accountshareroomMixin := schema.AccountShareRoom{}.Mixin()
	accountshareroomMixinFields0 := accountshareroomMixin[0].Fields()
	_ = accountshareroomMixinFields0
	accountshareroomFields := schema.AccountShareRoom{}.Fields()
	_ = accountshareroomFields
	// accountshareroomDescCreatedAt is the schema descriptor for created_at field.
	accountshareroomDescCreatedAt := accountshareroomMixinFields0[0].Descriptor()
	// accountshareroom.DefaultCreatedAt holds the default value on creation for the created_at field.
	accountshareroom.DefaultCreatedAt = accountshareroomDescCreatedAt.Default.(func() time.Time)
	// accountshareroomDescUpdatedAt is the schema descriptor for updated_at field.
	accountshareroomDescUpdatedAt := accountshareroomMixinFields0[1].Descriptor()
	// accountshareroom.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	accountshareroom.DefaultUpdatedAt = accountshareroomDescUpdatedAt.Default.(func() time.Time)
	// accountshareroom.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	accountshareroom.UpdateDefaultUpdatedAt = accountshareroomDescUpdatedAt.UpdateDefault.(func() time.Time)
	// accountshareroomDescName is the schema descriptor for name field.
	accountshareroomDescName := accountshareroomFields[2].Descriptor()
	// accountshareroom.NameValidator is a validator for the "name" field. It is called by the builders before save.
	accountshareroom.NameValidator = func() func(string) error {
		validators := accountshareroomDescName.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// accountshareroomDescStatus is the schema descriptor for status field.
	accountshareroomDescStatus := accountshareroomFields[3].Descriptor()
	// accountshareroom.DefaultStatus holds the default value on creation for the status field.
	accountshareroom.DefaultStatus = accountshareroomDescStatus.Default.(string)
	// accountshareroom.StatusValidator is a validator for the "status" field. It is called by the builders before save.
	accountshareroom.StatusValidator = accountshareroomDescStatus.Validators[0].(func(string) error)
	// accountshareroomDescSeatLimit is the schema descriptor for seat_limit field.
	accountshareroomDescSeatLimit := accountshareroomFields[4].Descriptor()
	// accountshareroom.DefaultSeatLimit holds the default value on creation for the seat_limit field.
	accountshareroom.DefaultSeatLimit = accountshareroomDescSeatLimit.Default.(int)
	// accountshareroomDescRateMultiplier is the schema descriptor for rate_multiplier field.
	accountshareroomDescRateMultiplier := accountshareroomFields[5].Descriptor()
	// accountshareroom.DefaultRateMultiplier holds the default value on creation for the rate_multiplier field.
	accountshareroom.DefaultRateMultiplier = accountshareroomDescRateMultiplier.Default.(float64)
	// accountshareroomDescPerUserConcurrency is the schema descriptor for per_user_concurrency field.
	accountshareroomDescPerUserConcurrency := accountshareroomFields[7].Descriptor()
	// accountshareroom.DefaultPerUserConcurrency holds the default value on creation for the per_user_concurrency field.
	accountshareroom.DefaultPerUserConcurrency = accountshareroomDescPerUserConcurrency.Default.(int)
	// accountshareroomDescQueueMax is the schema descriptor for queue_max field.
	accountshareroomDescQueueMax := accountshareroomFields[8].Descriptor()
	// accountshareroom.DefaultQueueMax holds the default value on creation for the queue_max field.
	accountshareroom.DefaultQueueMax = accountshareroomDescQueueMax.Default.(int)
	// accountshareroomDescVersion is the schema descriptor for version field.
	accountshareroomDescVersion := accountshareroomFields[9].Descriptor()
	// accountshareroom.DefaultVersion holds the default value on creation for the version field.
	accountshareroom.DefaultVersion = accountshareroomDescVersion.Default.(int)
	...
	ownerledgerMixin := schema.OwnerLedger{}.Mixin()
	ownerledgerMixinFields0 := ownerledgerMixin[0].Fields()
	_ = ownerledgerMixinFields0
	ownerledgerFields := schema.OwnerLedger{}.Fields()
	_ = ownerledgerFields
	// ownerledgerDescCreatedAt is the schema descriptor for created_at field.
	ownerledgerDescCreatedAt := ownerledgerMixinFields0[0].Descriptor()
	// ownerledger.DefaultCreatedAt holds the default value on creation for the created_at field.
	ownerledger.DefaultCreatedAt = ownerledgerDescCreatedAt.Default.(func() time.Time)
	// ownerledgerDescUpdatedAt is the schema descriptor for updated_at field.
	ownerledgerDescUpdatedAt := ownerledgerMixinFields0[1].Descriptor()
	// ownerledger.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	ownerledger.DefaultUpdatedAt = ownerledgerDescUpdatedAt.Default.(func() time.Time)
	// ownerledger.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	ownerledger.UpdateDefaultUpdatedAt = ownerledgerDescUpdatedAt.UpdateDefault.(func() time.Time)
	// ownerledgerDescEntryType is the schema descriptor for entry_type field.
	ownerledgerDescEntryType := ownerledgerFields[5].Descriptor()
	// ownerledger.EntryTypeValidator is a validator for the "entry_type" field. It is called by the builders before save.
	ownerledger.EntryTypeValidator = func() func(string) error {
		validators := ownerledgerDescEntryType.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
		return func(entry_type string) error {
			for _, fn := range fns {
				if err := fn(entry_type); err != nil {
					return err
				}
			}
			return nil
	...
	// ownerledgerDescRefType is the schema descriptor for ref_type field.
	ownerledgerDescRefType := ownerledgerFields[6].Descriptor()
	// ownerledger.RefTypeValidator is a validator for the "ref_type" field. It is called by the builders before save.
	ownerledger.RefTypeValidator = ownerledgerDescRefType.Validators[0].(func(string) error)
	...
	settlementDescUpdatedAt := settlementMixinFields0[1].Descriptor()
	...
	// settlementDescSettlementNo is the schema descriptor for settlement_no field.
	settlementDescSettlementNo := settlementFields[1].Descriptor()
	// settlement.SettlementNoValidator is a validator for the "settlement_no" field. It is called by the builders before save.
	settlement.SettlementNoValidator = func() func(string) error {
		validators := settlementDescSettlementNo.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
		return func(settlement_no string) error {
			for _, fn := range fns {
				if err := fn(settlement_no); err != nil {
					return err
				}
			}
			return nil
	...
	// settlementDescGrossAmount is the schema descriptor for gross_amount field.
	settlementDescGrossAmount := settlementFields[4].Descriptor()
	// settlement.DefaultGrossAmount holds the default value on creation for the gross_amount field.
	settlement.DefaultGrossAmount = settlementDescGrossAmount.Default.(float64)
	// settlementDescFeeAmount is the schema descriptor for fee_amount field.
	settlementDescFeeAmount := settlementFields[5].Descriptor()
	// settlement.DefaultFeeAmount holds the default value on creation for the fee_amount field.
	settlement.DefaultFeeAmount = settlementDescFeeAmount.Default.(float64)
	// settlementDescNetAmount is the schema descriptor for net_amount field.
	settlementDescNetAmount := settlementFields[6].Descriptor()
	// settlement.DefaultNetAmount holds the default value on creation for the net_amount field.
	settlement.DefaultNetAmount = settlementDescNetAmount.Default.(float64)
	// settlementDescStatus is the schema descriptor for status field.
	settlementDescStatus := settlementFields[7].Descriptor()
	// settlement.DefaultStatus holds the default value on creation for the status field.
	settlement.DefaultStatus = settlementDescStatus.Default.(string)
	// settlement.StatusValidator is a validator for the "status" field. It is called by the builders before save.
	settlement.StatusValidator = settlementDescStatus.Validators[0].(func(string) error)
	sharepolicyMixin := schema.SharePolicy{}.Mixin()
	sharepolicyMixinHooks1 := sharepolicyMixin[1].Hooks()
	sharepolicy.Hooks[0] = sharepolicyMixinHooks1[0]
	sharepolicyMixinInters1 := sharepolicyMixin[1].Interceptors()
	sharepolicy.Interceptors[0] = sharepolicyMixinInters1[0]
	sharepolicyMixinFields0 := sharepolicyMixin[0].Fields()
	_ = sharepolicyMixinFields0
	sharepolicyFields := schema.SharePolicy{}.Fields()
	_ = sharepolicyFields
	// sharepolicyDescCreatedAt is the schema descriptor for created_at field.
	sharepolicyDescCreatedAt := sharepolicyMixinFields0[0].Descriptor()
	// sharepolicy.DefaultCreatedAt holds the default value on creation for the created_at field.
	sharepolicy.DefaultCreatedAt = sharepolicyDescCreatedAt.Default.(func() time.Time)
	// sharepolicyDescUpdatedAt is the schema descriptor for updated_at field.
	sharepolicyDescUpdatedAt := sharepolicyMixinFields0[1].Descriptor()
	// sharepolicy.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	sharepolicy.DefaultUpdatedAt = sharepolicyDescUpdatedAt.Default.(func() time.Time)
	// sharepolicy.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	sharepolicy.UpdateDefaultUpdatedAt = sharepolicyDescUpdatedAt.UpdateDefault.(func() time.Time)
	// sharepolicyDescScopeType is the schema descriptor for scope_type field.
	sharepolicyDescScopeType := sharepolicyFields[0].Descriptor()
	// sharepolicy.ScopeTypeValidator is a validator for the "scope_type" field. It is called by the builders before save.
	sharepolicy.ScopeTypeValidator = func() func(string) error {
		validators := sharepolicyDescScopeType.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// sharepolicyDescPlatform is the schema descriptor for platform field.
	sharepolicyDescPlatform := sharepolicyFields[2].Descriptor()
	// sharepolicy.PlatformValidator is a validator for the "platform" field. It is called by the builders before save.
	sharepolicy.PlatformValidator = sharepolicyDescPlatform.Validators[0].(func(string) error)
	// sharepolicyDescOwnerShareRatio is the schema descriptor for owner_share_ratio field.
	sharepolicyDescOwnerShareRatio := sharepolicyFields[3].Descriptor()
	// sharepolicy.OwnerShareRatioValidator is a validator for the "owner_share_ratio" field. It is called by the builders before save.
	sharepolicy.OwnerShareRatioValidator = sharepolicyDescOwnerShareRatio.Validators[0].(func(float64) error)
	// sharepolicyDescInviteShareRatio is the schema descriptor for invite_share_ratio field.
	sharepolicyDescInviteShareRatio := sharepolicyFields[4].Descriptor()
	// sharepolicy.DefaultInviteShareRatio holds the default value on creation for the invite_share_ratio field.
	sharepolicy.DefaultInviteShareRatio = sharepolicyDescInviteShareRatio.Default.(float64)
	// sharepolicyDescVersion is the schema descriptor for version field.
	sharepolicyDescVersion := sharepolicyFields[5].Descriptor()
	// sharepolicy.DefaultVersion holds the default value on creation for the version field.
	sharepolicy.DefaultVersion = sharepolicyDescVersion.Default.(int)
	// sharepolicyDescEnabled is the schema descriptor for enabled field.
	sharepolicyDescEnabled := sharepolicyFields[6].Descriptor()
	// sharepolicy.DefaultEnabled holds the default value on creation for the enabled field.
	sharepolicy.DefaultEnabled = sharepolicyDescEnabled.Default.(bool)
	...
	usagelogDescUpstreamResponseModel := usagelogFields[8].Descriptor()
	...
	usagelogDescRateMultiplier := usagelogFields[28].Descriptor()
	...
	// userDescCanHostAccounts is the schema descriptor for can_host_accounts field.
	userDescCanHostAccounts := userFields[21].Descriptor()
	// user.DefaultCanHostAccounts holds the default value on creation for the can_host_accounts field.
	user.DefaultCanHostAccounts = userDescCanHostAccounts.Default.(bool)
	...
	// withdrawalDescFeeAmount is the schema descriptor for fee_amount field.
	withdrawalDescFeeAmount := withdrawalFields[2].Descriptor()
	// withdrawal.DefaultFeeAmount holds the default value on creation for the fee_amount field.
	withdrawal.DefaultFeeAmount = withdrawalDescFeeAmount.Default.(float64)
	// withdrawalDescTotalDeducted is the schema descriptor for total_deducted field.
	withdrawalDescTotalDeducted := withdrawalFields[3].Descriptor()
	// withdrawal.DefaultTotalDeducted holds the default value on creation for the total_deducted field.
	withdrawal.DefaultTotalDeducted = withdrawalDescTotalDeducted.Default.(float64)
	// withdrawalDescPaymentMethod is the schema descriptor for payment_method field.
	withdrawalDescPaymentMethod := withdrawalFields[6].Descriptor()
	// withdrawal.PaymentMethodValidator is a validator for the "payment_method" field. It is called by the builders before save.
	withdrawal.PaymentMethodValidator = func() func(string) error {
		validators := withdrawalDescPaymentMethod.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// withdrawalDescPaymentAccount is the schema descriptor for payment_account field.
	withdrawalDescPaymentAccount := withdrawalFields[7].Descriptor()
	// withdrawal.PaymentAccountValidator is a validator for the "payment_account" field. It is called by the builders before save.
	withdrawal.PaymentAccountValidator = func() func(string) error {
		validators := withdrawalDescPaymentAccount.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
		return func(payment_account string) error {
			for _, fn := range fns {
				if err := fn(payment_account); err != nil {
					return err
				}
			}
			return nil
	...
	// withdrawalDescStatus is the schema descriptor for status field.
	withdrawalDescStatus := withdrawalFields[8].Descriptor()
	// withdrawal.DefaultStatus holds the default value on creation for the status field.
	withdrawal.DefaultStatus = withdrawalDescStatus.Default.(string)
	// withdrawal.StatusValidator is a validator for the "status" field. It is called by the builders before save.
	withdrawal.StatusValidator = withdrawalDescStatus.Validators[0].(func(string) error)
}
