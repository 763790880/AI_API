...
func (_u *AccountUpdate) ClearAccountLevel() *AccountUpdate {
	_u.mutation.ClearAccountLevel()
	return _u
}

// SetMaxSeats sets the "max_seats" field.
func (_u *AccountUpdate) SetMaxSeats(v int) *AccountUpdate {
	_u.mutation.ResetMaxSeats()
	_u.mutation.SetMaxSeats(v)
	return _u
}

// SetNillableMaxSeats sets the "max_seats" field if the given value is not nil.
func (_u *AccountUpdate) SetNillableMaxSeats(v *int) *AccountUpdate {
	if v != nil {
		_u.SetMaxSeats(*v)
	}
	return _u
...
// AddMaxSeats adds value to the "max_seats" field.
func (_u *AccountUpdate) AddMaxSeats(v int) *AccountUpdate {
	_u.mutation.AddMaxSeats(v)
	return _u
}
...
func (_u *AccountUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.AccountLevelCleared() {
		_spec.ClearField(account.FieldAccountLevel, field.TypeString)
	}
	if value, ok := _u.mutation.MaxSeats(); ok {
		_spec.SetField(account.FieldMaxSeats, field.TypeInt, value)
	}
	if value, ok := _u.mutation.AddedMaxSeats(); ok {
		_spec.AddField(account.FieldMaxSeats, field.TypeInt, value)
	}
...
// ClearAccountLevel clears the value of the "account_level" field.
func (_u *AccountUpdateOne) ClearAccountLevel() *AccountUpdateOne {
	_u.mutation.ClearAccountLevel()
	return _u
}

// SetMaxSeats sets the "max_seats" field.
func (_u *AccountUpdateOne) SetMaxSeats(v int) *AccountUpdateOne {
	_u.mutation.ResetMaxSeats()
	_u.mutation.SetMaxSeats(v)
	return _u
}
...
// SetNillableMaxSeats sets the "max_seats" field if the given value is not nil.
func (_u *AccountUpdateOne) SetNillableMaxSeats(v *int) *AccountUpdateOne {
	if v != nil {
		_u.SetMaxSeats(*v)
	}
	return _u
...
// AddMaxSeats adds value to the "max_seats" field.
func (_u *AccountUpdateOne) AddMaxSeats(v int) *AccountUpdateOne {
	_u.mutation.AddMaxSeats(v)
	return _u
}
