...
// SetCanHostAccounts sets the "can_host_accounts" field.
func (_c *UserCreate) SetCanHostAccounts(v bool) *UserCreate {
	_c.mutation.SetCanHostAccounts(v)
	return _c
}

// SetNillableCanHostAccounts sets the "can_host_accounts" field if the given value is not nil.
func (_c *UserCreate) SetNillableCanHostAccounts(v *bool) *UserCreate {
	if v != nil {
		_c.SetCanHostAccounts(*v)
	}
	return _c
}
...
func (_c *UserCreate) defaults() error {
	...
	if _, ok := _c.mutation.CanHostAccounts(); !ok {
		v := user.DefaultCanHostAccounts
		_c.mutation.SetCanHostAccounts(v)
	}
	return nil
}
...
func (_c *UserCreate) check() error {
	...
	if _, ok := _c.mutation.CanHostAccounts(); !ok {
		return &ValidationError{Name: "can_host_accounts", err: errors.New(`ent: missing required field "User.can_host_accounts"`)}
	}
	return nil
}
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.CanHostAccounts(); ok {
		_spec.SetField(user.FieldCanHostAccounts, field.TypeBool, value)
		_node.CanHostAccounts = value
	}
...
// SetCanHostAccounts sets the "can_host_accounts" field.
func (u *UserUpsert) SetCanHostAccounts(v bool) *UserUpsert {
	u.Set(user.FieldCanHostAccounts, v)
	return u
}

// UpdateCanHostAccounts sets the "can_host_accounts" field to the value that was provided on create.
func (u *UserUpsert) UpdateCanHostAccounts() *UserUpsert {
	u.SetExcluded(user.FieldCanHostAccounts)
	return u
}
...
// SetCanHostAccounts sets the "can_host_accounts" field.
func (u *UserUpsertOne) SetCanHostAccounts(v bool) *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.SetCanHostAccounts(v)
	})
}

// UpdateCanHostAccounts sets the "can_host_accounts" field to the value that was provided on create.
func (u *UserUpsertOne) UpdateCanHostAccounts() *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.UpdateCanHostAccounts()
	})
}
...
// SetCanHostAccounts sets the "can_host_accounts" field.
func (u *UserUpsertBulk) SetCanHostAccounts(v bool) *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.SetCanHostAccounts(v)
	})
}
...
// UpdateCanHostAccounts sets the "can_host_accounts" field to the value that was provided on create.
func (u *UserUpsertBulk) UpdateCanHostAccounts() *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.UpdateCanHostAccounts()
	})
}
