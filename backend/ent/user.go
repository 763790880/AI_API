...
type User struct {
	...
	// Whether the user can host accounts and participate in revenue sharing.
	CanHostAccounts bool `json:"can_host_accounts,omitempty"`
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case user.FieldTotpEnabled, user.FieldBalanceNotifyEnabled, user.FieldCanHostAccounts:
...
func (_m *User) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case user.FieldCanHostAccounts:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field can_host_accounts", values[i])
			} else if value.Valid {
				_m.CanHostAccounts = value.Bool
			}
		default:
...
func (_m *User) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("can_host_accounts=")
	builder.WriteString(fmt.Sprintf("%v", _m.CanHostAccounts))
	builder.WriteByte(')')
