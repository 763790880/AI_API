    ...
    <div class="app-header-inner">
      ...
      <div class="flex flex-none items-center gap-2 lg:min-w-0 lg:flex-1 lg:gap-4">
        ...
        <div class="hidden min-w-0 lg:block">
          <h1 class="truncate text-base font-semibold tracking-tight text-content xl:text-lg">
            {{ pageTitle }}
          </h1>
          <p v-if="pageDescription" class="truncate text-xs text-content-subtle">
            {{ pageDescription }}
          </p>
        </div>
      </div>
        ...
        <div v-if="user" class="relative min-w-0 flex-none" ref="dropdownRef">
          ...
          >
            ...
            <div class="hidden min-w-0 max-w-48 text-left xl:block">
              ...
              <div class="text-xs capitalize text-content-subtle">
                {{ user.role }}
              </div>
            </div>
